...
class Item(models.Model):
    ...
    image = models.ImageField(upload_to="item_images", blank=True, null=True)   # specifica posizione image, se non esiste django crea la cartella
    is_sold = models.BooleanField(default=False)
    created_by = models.ForeignKey(User, related_name='items', on_delete=models.CASCADE)    # link tra due db (users e items)
